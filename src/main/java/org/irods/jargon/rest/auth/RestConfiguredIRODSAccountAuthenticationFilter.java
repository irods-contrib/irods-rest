...
import org.irods.jargon.spring.security.IRODSAccountAuthenticationManager;
 ...
 * 
 */
public class RestConfiguredIRODSAccountAuthenticationFilter extends
		UsernamePasswordAuthenticationFilter {
	
	/**
	 * Dependency on configuration information that controls the connection information for this grid
	 */
	private RestConfiguration restConfiguration;

	public RestConfiguredIRODSAccountAuthenticationFilter() {
		super();
	}
