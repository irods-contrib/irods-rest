...
public class ListAllTicketsServiceTest implements ApplicationContextAware {
	...
	public void setUp() throws Exception {
		...
		SpringResourceFactory noDefaults = new SpringResourceFactory("listAllTicketsService", applicationContext,
	...
	public void listAllTicketsXml() throws Exception {
		...
		ticketService.addTicketUserRestriction(ticketString1,
				testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_KEY));
		ticketService.addTicketGroupRestriction(ticketString1,
		...
		ticketService.addTicketUserRestriction(ticketString2,
				testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_KEY));
		ticketService.addTicketGroupRestriction(ticketString2,
				testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_GROUP_KEY));
		...
		String expectedResponse2 = "<ticket>" + "<ticket_id>" + ticketId1 + "</ticket_id>" + "<ticket_string>"
				+ ticketString1 + "</ticket_string>" + "<ticket_type>read</ticket_type>"
				+ "<object_type>data_object</object_type>" + "<owner_name>"
				+ testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_KEY) + "</owner_name>"
				+ "<owner_zone>" + testingProperties.getProperty(TestingPropertiesHelper.IRODS_ZONE_KEY)
				+ "</owner_zone>" + "<uses_count>0</uses_count>" + "<uses_limit>20</uses_limit>"
				+ "<write_file_count>0</write_file_count>" + "<write_file_limit>10</write_file_limit>"
				+ "<write_byte_count>0</write_byte_count>" + "<write_byte_limit>1000</write_byte_limit>"
				+ "<expire_time>" + EXPIRATION_DATE_FORMAT.format(expirationTime1) + "</expire_time>" + "<irods_path>"
				+ targetIrodsFile + "</irods_path>" + "<host_restrictions>";

		String expectedResponse3 = "</host_restrictions>" + "<user_restrictions>"
				+ testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_KEY) + "</user_restrictions>"
				+ "<group_restrictions>" + testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_GROUP_KEY)
				+ "</group_restrictions>" + "</ticket>";

		String expectedResponse4 = "<ticket>" + "<ticket_id>" + ticketId2 + "</ticket_id>" + "<ticket_string>"
				+ ticketString2 + "</ticket_string>" + "<ticket_type>write</ticket_type>"
				+ "<object_type>data_object</object_type>" + "<owner_name>"
				+ testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_KEY) + "</owner_name>"
				+ "<owner_zone>" + testingProperties.getProperty(TestingPropertiesHelper.IRODS_ZONE_KEY)
				+ "</owner_zone>" + "<uses_count>0</uses_count>" + "<uses_limit>21</uses_limit>"
				+ "<write_file_count>0</write_file_count>" + "<write_file_limit>11</write_file_limit>"
				+ "<write_byte_count>0</write_byte_count>" + "<write_byte_limit>1001</write_byte_limit>"
				+ "<expire_time>" + EXPIRATION_DATE_FORMAT.format(expirationTime2) + "</expire_time>" + "<irods_path>"
				+ targetIrodsFile + "</irods_path>" + "<host_restrictions>";
		...
		try {
			...
			Assert.assertTrue(
					...
					index2 > -1);
			Assert.assertTrue(
					"Did not get expected xml stuff.  Received: " + entityData + "Expected: " + expectedResponse3,
					index3 > -1);
			Assert.assertTrue(
					"Did not get expected xml stuff.  Received: " + entityData + "Expected: " + expectedResponse4,
					index4 > -1);
	...
	public void listAllTicketsJson() throws Exception {
		...
		String expectedResponse2 = "{" + "\"ticket_id\":\"" + ticketId1 + "\"," + "\"ticket_string\":\"" + ticketString1
				...
				+ EXPIRATION_DATE_FORMAT.format(expirationTime1) + "\"," + "\"irods_path\":\"" + targetIrodsFile + "\","
				+ "\"host_restrictions\":[\"";
		String expectedResponse3 = "\"]," + "\"user_restrictions\":[\""
				+ testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_KEY) + "\"],"
				+ "\"group_restrictions\":[\""
				+ testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_GROUP_KEY) + "\"]" + "}";
		String expectedResponse4 = "{" + "\"ticket_id\":\"" + ticketId2 + "\"," + "\"ticket_string\":\"" + ticketString2
				+ "\"," + "\"ticket_type\":\"write\"," + "\"object_type\":\"data_object\"," + "\"owner_name\":\""
				+ testingProperties.getProperty(TestingPropertiesHelper.IRODS_USER_KEY) + "\"," + "\"owner_zone\":\""
				+ testingProperties.getProperty(TestingPropertiesHelper.IRODS_ZONE_KEY) + "\"," + "\"uses_count\":0,"
				+ "\"uses_limit\":21," + "\"write_file_count\":0," + "\"write_file_limit\":11,"
				+ "\"write_byte_count\":0," + "\"write_byte_limit\":1001," + "\"expire_time\":\""
				+ EXPIRATION_DATE_FORMAT.format(expirationTime2) + "\"," + "\"irods_path\":\"" + targetIrodsFile + "\","
				+ "\"host_restrictions\":[\"";
