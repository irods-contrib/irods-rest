...
@SuiteClasses({ UserGroupServiceTest.class, UserServiceTest.class, ServerEnvironmentServiceTest.class,
		...
		DataObjectAclFunctionsImplTest.class, DataObjectAvuFunctionsImplTest.class,

		// RuleFunctionsImplTest.class,

		// RuleServiceTest.class,
		IrodsCorsFilterTest.class, TemporaryPasswordServiceTest.class, PamAuthTest.class,
